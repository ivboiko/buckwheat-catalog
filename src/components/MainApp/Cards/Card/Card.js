...
import { setShop } from "../../../../redux/reducers/app-reducer";
...
const Card = ({
  ...
  const cardContainerClassName = classNames("card-container", {
  ...
  return (
    <div className={cardContainerClassName}>
      <div className={getTextClassName("number", appTheme)}>{number}.</div>
      <div className="logo">
      ...
      <div className={getTextClassName("text", appTheme)}>
        ...
        <div className={getTextClassName("product-name", appTheme)}>
          <a className={linkClassName} href={productLink}>
            {productName}
          </a>
        </div>
      ...
      <div className="price-container">
        <div className={getTextClassName("price", appTheme)}>₴{price}</div>
        {bestPrice && <BestPrice />}
      </div>
